...
public class AddressDTO implements Comparable<AddressDTO> {
	...
	public static final Comparator<AddressDTO> comparatorTown = Comparator.comparing( ( AddressDTO obj ) -> obj.getTown().toUpperCase() );
	public static final Comparator<AddressDTO> comparatorCity = Comparator.comparing( ( AddressDTO obj ) -> obj.getCity().toUpperCase() );
